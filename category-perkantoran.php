...
<?php include 'maps/perkantoran.php'  ?>
<main id="main">
    <section id="schedule" class="section-with-bg" style="background-color:#0e1626">
        <div class="container mt-4">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link active mt-3" href="#perkantoran">Perkantoran</a>
                </li>
                <li class="nav-item">
            ...
            <div class="card rounded-5 p-3">
                <div class="section-header">
                    <h2 class="mt-5">Titik Lokasi 5G - Perkantoran</h2>
                </div>
                ...
                <div class="tab-content row justify-content-center">
                    ...
                    <!-- Schdule Day 3 -->
                    <div role="tabpanel" class="col-lg-9  tab-pane fade show active" id="perkantoran">
