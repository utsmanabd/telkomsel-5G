...
<?php include 'maps/5ghotspot.php'  ?>
<main id="main">
...
<section id="schedule" class="section-with-bg" style="background-color:#0e1626">
    ...
    <div id="map"></div>
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link active mt-3" href="#hotspot">5G Hotspot</a>
            </li>
            <li class="nav-item">
        ...
        <div class="section-header">
            <h2 class="mt-5">Titik Lokasi 5G - 5G Hotspot</h2>
        </div>
        ...
        <div class="tab-content row justify-content-center">
            ...
            <!-- Schdule Day 1 -->
            <div role="tabpanel" class="col-lg-9 tab-pane fade show active" id="hotspot">
                <?php
